...
namespace ScooterBear.GTD.UnitTests.UserLabel
{
    public class AsTheLabelI
    {
        [Theory]
        ...
        public void ShouldNotAllowInvalidToExist(string labelId, string labelName, string userId,
            int count, bool isDeleted, int countOverdue, bool shouldPass)
        {
            var action = new Action(() => new Project(labelId, labelName,
